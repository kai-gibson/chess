...
Move_Piece move_piece(Moves m, i8 start, i8 end, bool is_white, bool gen=true);
...
struct Arrays {
    ...
    const std::array<std::array<u64, 8>, 64> path_moves = {{
        {
            0x0101010101010100, // TOP
            0x0000000000000000, // TOP_RIGHT
            0x0000000000000000, // RIGHT
            0x0000000000000000, // BOTTOM_RIGHT
            0x0000000000000000, // BOTTOM
            0x0000000000000000, // BOTTOM_LEFT
            0x00000000000000FE, // LEFT
            0x8040201008040200  // TOP_LEFT
        },
        {
            0x0202020202020200,
            0x0000000000000100,
        ...
        },
        {
            ...
            0x0000000000000000,
            0x0000000000000000,
            0x00000000000000E0, 0x0000000080402000
        },
        {
            0x2020202020202000,
            0x0000010204081000,
    ...
    std::array<std::array<u64,4>, 64> pawn_moves = {{
        {
            ...
            0x0000000000000200, // WHITE_ATTACK
            0x0000000000000000, // BLACK_MOVE
            0x0000000000000000  // BLACK_ATTACK
        },
        {
            0x0000000000000200,
            0x0000000000000500,
        ...
        {
            0x8000000000000000, // WHITE_MOVE
            0x4000000000000000, // WHITE_ATTACK
            0x0000808000000000, // BLACK_MOVE
            0x0000400000000000  // BLACK_ATTACK
        },
        {
            0x0000000000000000,
            0x0000000000000000,
